...
% Run RRT algorithm
[tree, path] = rrt_star_algorithm(environment, 5*environment.step_size, 5, 0.3);
%[tree, path] = rrt_algorithm(environment, 1);
%[tree, path] = bidirectional_rrt_star_algorithm(environment, 5*environment.step_size, 5, 0.5);
